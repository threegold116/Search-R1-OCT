...
# export DATA_DIR='/share/home/sxjiang/myproject/Search-R1-OCT/scripts/data_process/data/nq_search-origin'
# export EXPERIMENT_NAME=${data_name}-search-r1-grpo-qwen2.5-3b-em-20250629-100
# PYTHONUNBUFFERED=1 python3 -m verl.trainer.main_ppo \
#     data.train_files=$DATA_DIR/train.parquet \
#     data.val_files=$DATA_DIR/test.parquet \
#     data.train_data_num=null \
